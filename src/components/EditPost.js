...
function EditPost() {
  ...
  const fillEditInputs = useCallback(async () => {
    try {
    ...
    return (
      <div className="bg-gray-50 dark:bg-gray-900 h-screen p-4">
        <div className="px-6 py-8 mx-auto mt-10 lg:py-0">
          <div className="max-w-5xl mx-auto bg-white dark:text-white rounded-lg shadow dark:border md:mt-0 xl:p-0 dark:bg-gray-800 dark:border-gray-700">
            <div className="w-full p-6 space-y-4 md:space-y-6 sm:p-8 text-center">
              <h1 className="text-2xl font-bold leading-tight tracking-tight text-gray-900 md:text-2xl dark:text-white">Success</h1>
              <p className="text-lg text-gray-900 dark:text-white">Post was updated.</p>
              <p className="text-3xl">✅</p>
            </div>
            <Link to={"/ViewPost?id=" + editPostData.id} className="mx-2">
              <button className="my-5 mx-auto block text-white bg-slate-600 hover:bg-slate-500 focus:ring-4 focus:outline-none font-medium rounded-lg text-lg px-5 py-2.5 text-center">
                Return
              </button>
            </Link>
          </div>
              ...
              <form onSubmit={handleSubmit(updatePost)}>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full row bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg block p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                    placeholder="Body"
                    type="text"
                    onInput={(event) => {
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="resize-none bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                    placeholder="Tags"
                    type="text"
                    {...register("tags", {})}
                  />
